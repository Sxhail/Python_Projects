...
class TicTacToe:
    ...
    def print_board_nums():
        # 0 | 1 | 2 etc (tells what num corresponds to box)
    ...
    def winner(self, square, letter):
        ...
        if square % 2 == 0:
            diagonal1 = [self.board[i] for i in [0, 4, 8]] # left to right direction
            if all([spot == letter for spot in diagonal1]):
                return True
            diagonal2 = [self.board[i] for i in [2, 4, 6]] # right to left direction
